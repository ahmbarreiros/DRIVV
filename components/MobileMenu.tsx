...
const MobileMenu: React.FC<MobileMenuProps> = ({ visible }) => {
    ...
    return (
        <div className="bg-black/90 w-56 absolute top-8 left-[-100%] py-5 flex-col border-2 border-gray-800 border-t-[#fa7f1a] border-t-[3px] flex hover:bg-black transition duration-300">
